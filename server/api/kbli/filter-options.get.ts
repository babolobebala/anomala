import { kbliMasterSlsWhere, type KbliListFilters, parseKbliListFilters } from '../../utils/kbli-query'
import { prisma } from '../../utils/prisma'

function selectedMasterSlsWhere(filters: KbliListFilters, omit?: 'ppl' | 'pml') {
  return {
