import { v as vue_exports, ae as navigateTo } from '../virtual/entry.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
...
var index_vue_vue_type_script_setup_true_lang_default = /*@__PURE__*/ (0, vue_exports.defineComponent)({
	...
	async setup(__props) {
		...
		[__temp, __restore] = (0, vue_exports.withAsyncContext)(() => navigateTo("/tidak-ditemukan", { redirectCode: 302 })), await __temp, __restore();
		return () => {};
	}
});
//#endregion
...
//# sourceMappingURL=pages-ChWsOrCP.mjs.map
