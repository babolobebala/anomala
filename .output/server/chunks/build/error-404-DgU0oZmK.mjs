import { _ as _plugin_vue_export_helper_default, v as vue_exports, af as useHead$1, s as server_renderer_exports, O as NuxtLink } from '../virtual/entry.mjs';
import '../_/nitro.mjs';
import 'node:http';
import 'node:https';
import 'node:events';
...
//#region node_modules/.pnpm/nuxt@4.5.2_@babel+plugin-sy_2642c4b94b748e7cd728207476161789/node_modules/nuxt/dist/app/components/error-404.vue
var _sfc_main = {
	__name: "error-404",
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			...
			_push(`<div${(0, server_renderer_exports.ssrRenderAttrs)((0, vue_exports.mergeProps)({ class: "antialiased bg-white dark:bg-[#020420] dark:text-white font-sans grid min-h-screen overflow-hidden place-content-center text-[#020420] tracking-wide" }, _attrs))} data-v-cea7edcf><div class="max-w-520px text-center" data-v-cea7edcf><h1 class="font-semibold leading-none mb-4 sm:text-[110px] tabular-nums text-[80px]" data-v-cea7edcf>${(0, server_renderer_exports.ssrInterpolate)(__props.status)}</h1><h2 class="font-semibold mb-2 sm:text-3xl text-2xl" data-v-cea7edcf>${(0, server_renderer_exports.ssrInterpolate)(__props.statusText)}</h2><p class="mb-4 px-2 text-[#64748B] text-md" data-v-cea7edcf>${(0, server_renderer_exports.ssrInterpolate)(__props.description)}</p><div class="flex items-center justify-center w-full" data-v-cea7edcf>`);
...
_sfc_main.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/nuxt@4.5.2_@babel+plugin-sy_2642c4b94b748e7cd728207476161789/node_modules/nuxt/dist/app/components/error-404.vue");
	return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
var error_404_default = /*#__PURE__*/ _plugin_vue_export_helper_default(_sfc_main, [["__scopeId", "data-v-cea7edcf"]]);

export { error_404_default as default };
//# sourceMappingURL=error-404-DgU0oZmK.mjs.map
